...
$query = "INSERT INTO `donors`(`name`, `age`, `gender`, `blood_group`, `contact_no`, `email`, `password`, `city`, `donation_date`, `status`, `address`) 
           VALUES ('$name','$age','$gender','$blood_group','$contact_no','$email','$password','$city','$donation_date','$status','$address')";
...
<body>
   ...
   <main class="content">
    ...
    <div >
                <form action="donor_registration.php" method="post" onsubmit="return validateForm();">
...
<table >
    <tr> 
         ...
         <tr> 
            ...
            <td><input type="text" class="form-control" id="name" name="name" placeholder="Enter Your Full name" required> </td>
</tr>
 <tr> 

            <td> <label for="age" class="form-label">Age:</label>
                        </td>
            <td> <input type="integer" class="form-control" id="age" name="age" placeholder="Enter your Age" required></td>
</tr>
 <tr> 
 ...
 <tr> 
            ...
            <td><input type="text" class="form-control" id="contact_no" name="contact_no" placeholder="Enter contact number" required> </td>
</tr>
     <tr> 
 ...
 <tr> 
            <td><label for="password" class="form-label">Password:</label>
                         </td>
...
<tr> 
            ...
            <td><input type="text" class="form-control" id="city" name="city" placeholder="Enter city" required> </td>
</tr>
 <tr> 
            <td> <label for="address" class="form-label">Address:</label>
                         </td>
            <td> <input type="text" class="form-control" id="address" name="address" placeholder="Enter Address" required></td>
</tr>
 <tr> 
            <td> </td>
            <td><button type="submit" name="signup" class="btn btn-success">Sign Up</button> </td>
</tr> 
<tr> 
            <td> </td>
            <td> </td>

...
//INSERT INTO `users`(`name`, `age`, `gender`, `blood_group`, `contact_no`, `email`, `password`, `city`, `donation_date`, `status`, `role`, `address`)
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body">
                    ...
                    <form action="bank_manager_reg.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 text-center">
                                <button type="submit" name="signup" class="btn bg-success text-light px-5">

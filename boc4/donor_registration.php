...
//print_r($data);
   ...
   $saveData=SaveDonorPersonalInfo($name,$age,$gender,$blood_group,$contact_no,$email,$password,$city,$donation_date,$status,$role,$address);
                    ...
                    <form action="donor_registration.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 text-center">
                                <button type="submit" name="signup" class="btn btn-danger px-5">

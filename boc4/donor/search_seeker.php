...
{
    $data= $_POST['data'];
 $query = "SELECT * FROM `users` where role='seeker' and `city`='$data' or `blood_group`='$data'";
    ...
    {  while ($donors = $result->fetch_assoc()) 
        ...
        <tr>
         <td>#</td>
            ...
            <td>
                                <a href="sendMsgToSeeker.php?id=<?php echo $donors['email']; ?>" class="btn btn-sm btn-success">Send Message</a>
